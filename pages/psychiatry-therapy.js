...
import PsychiatryTherapyContainer from "@/components/containers/psychiatry-therapy-container"
import Layout from "@/components/layout/layout"

const PsychiatryTherapyPage = ({
  categoriesList,
  global,
  pageContext,
  deviceType,
    ...
    <Layout global={global} pageContext={pageContext}>
      ...
      <Seo
        metadata={{
          ...
          metaTitle: t("psychiatry"),
          metaDescription: t("psychiatry"),
        }}
      />
      <HeroBg>
        <div className="hero-content">
          <h6 className="hero-title">{t("psychiatry")}</h6>
          <span className="hero-subtitle">{t("medication_management")}</span>
        </div>
      </HeroBg>
      <PsychiatryTherapyContainer

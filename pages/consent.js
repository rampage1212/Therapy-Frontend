...
import ConsentContainer from "@/components/containers/consent-container"
    ...
    <Layout global={global} pageContext={pageContext}>
      ...
      <Seo
        metadata={{
          ...
          metaTitle: t("consent_form_teleconsultation"),
          metaDescription: t("consent_form_teleconsultation"),
        }}
      />
      <HeroBackground>
        <h6 className="hero_title">{t("consent_form_teleconsultation")}</h6>
      </HeroBackground>
      <ConsentContainer />
      <style jsx>{`
        .hero_title {

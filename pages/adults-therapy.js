...
import AdultsTherapyContainer from "@/components/containers/adults-therapy-container"
import Layout from "@/components/layout/layout"
import HomePath from "@/components/buttons/HomePath"

const AdultsTherapyPage = ({
  categoriesList,
  global,
  pageContext,
  deviceType,
    ...
    <Layout global={global} pageContext={pageContext}>
      ...
      <Seo
        metadata={{
          ...
          metaTitle: t("adult_therapy"),
          metaDescription: t("adult_therapy"),
        }}
      />
      <HeroBg>
        <div className="hero-content">
          <h6 className="hero-title">{t("therapy_for_me")}</h6>
          <HomePath title={t("adult_therapy")} />
          {/* <span className="hero-subtitle">{t("therapy_for_me")}</span> */}
        </div>
      </HeroBg>
      <AdultsTherapyContainer
...
export default connect(mapStateToProps, mapDispatchToProps)(AdultsTherapyPage)

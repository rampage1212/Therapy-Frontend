...
const DoctorBookingCard = ({ isMobile, doctor, onBack }) => {
    ...
    <div className="doctor-booking-card">
      ...
      <div className="body">
        ...
        <div className="flex flex-col lg:flex-row gap-5">
          <BackBtn onClick={onBack} text={t("go_to_back")} />
          <SubmitBtn
      ...
      <style jsx>{`
        ...
        .image-wrapper {
          @apply flex-shrink-0 w-[90vw] h-[90vw] lg:h-96 lg:w-96 rounded-tl-3xl rounded-tr-3xl lg:rounded-full overflow-hidden;
        }
        .body {

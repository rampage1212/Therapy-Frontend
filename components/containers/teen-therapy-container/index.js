...
import TeenImage from "@/images/services/teen.png"
...
const TeenTherapyContainer = ({ deviceType }) => {
  const router = useRouter()
  const carouselRef = useRef(null)
  const { t } = useTranslation()
  const [doctorsList, setDoctorsList] = useState([])
  const contentData = [t("teen_therapy_desc1"), t("teen_therapy_desc2")]
...
export default TeenTherapyContainer

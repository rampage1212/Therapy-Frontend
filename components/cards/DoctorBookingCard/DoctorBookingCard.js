...
const DoctorBookingCard = ({ doctor, isMobile }) => {
  ...
  return (
    <div className="doctor-booking-card">
      ...
      <style jsx>{`
        .doctor-booking-card {
          @apply flex flex-col items-center lg:flex-row gap-10 mb-12;
        }
        .image-wrapper {
          @apply flex-shrink-0 w-[90vw] h-[90vw] lg:h-[25rem] lg:w-[25rem] rounded-[1.25rem] overflow-hidden;
        }
        .body {
          @apply text-center lg:text-left;
          .name {
            @apply text-[#2E3333] text-4xl font-bold uppercase mb-5;
          }
          .specialist {
            @apply block text-gray-64 text-base mb-5;
          }
          ...
          .duration {
            @apply block text-[#2E3333] text-2xl mb-2;
            span {
              @apply font-bold;
            }
          }
          ...
          .price {
            @apply text-[#2E3333] text-4xl font-bold uppercase;
          }

          .unit {
            @apply text-[#2E3333] text-2xl;
          }
          .price-book {
            @apply flex flex-col lg:flex-row gap-5 lg:gap-0 items-center justify-between mb-10;
          }
        }

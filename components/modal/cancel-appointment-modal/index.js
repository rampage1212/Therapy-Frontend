...
import { cancelPatientAppointment } from "@/utils/api"
          ...
          <div className={"cancel-appointment-modal"}>
            ...
            {!isSuccess && !isFaild ? (
              <div className="cancel-wrapper">
                ...
                <h3>{t("sure_cancel_appointment")}</h3>
                {/* <p>
                ...
                <div className="note">
                  ...
                  />
                  <span>
                    {isBefore24Hours(appointmentDate) ? (
                      t("refund_credit_original_payment_method")
                    ) : (
                      <span>
                        No refund will be given to your account due cancellation
                        policy
                      </span>
                    )}
                  </span>

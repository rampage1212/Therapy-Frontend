...
import { doctorAppointmentRequest } from "@/utils/api"
import { requestType } from "@/utils/enums"

const RequestCancelAppointmentModal = ({
  isOpen = false,
  user,
  appointmentID,
  appointmentDate,
          ...
          <div className={"cancel-appointment-modal"}>
            ...
            {isSuccess ? (
              <div className="success-wrapper">
                ...
                <h3>{t("confirmed")}</h3>
                <p>{t("request_cancel_appointment_successed")}</p>
                <button
                  className="ok-btn"
                  onClick={() => {
                    handleClose()
            ...
            {isFaild ? (
              <div className="faild-wrapper">
                ...
                <h3>{t("failed")}</h3>
                <p>{t("request_cancel_booking_failed")}</p>
            ...
            {!isSuccess && !isFaild ? (
              <div className="cancel-wrapper">
                ...
                <h3>{t("sure_request_cancel_appointment")}</h3>
...
export default RequestCancelAppointmentModal

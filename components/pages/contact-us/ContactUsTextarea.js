    ...
    <>
      ...
      <style jsx>{`
        ...
        .contact-us-field {
          ...
          textarea {
            @apply p-mb18 md:p-18pxt lg:p-vw18 text-18pxm md:text-22pxt lg:text-18px outline-none w-full border-none appearance-none transition-colors ease-in duration-200 resize-none;
